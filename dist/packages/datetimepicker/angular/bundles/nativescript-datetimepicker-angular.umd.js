(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@nativescript/angular'), require('@nativescript/datetimepicker'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('nativescript-datetimepicker-angular', ['exports', '@angular/core', '@nativescript/angular', '@nativescript/datetimepicker', '@angular/forms'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['nativescript-datetimepicker-angular'] = {}, global.ng.core, global['ns-angular'], global['ns-datetimepicker'], global.ng.forms));
}(this, (function (exports, core, angular, datetimepicker, forms) { 'use strict';

    var DatePickerFieldDirective = /** @class */ (function () {
    ...
    var TimePickerFieldDirective = /** @class */ (function () {
    ...
    var DateTimePickerFieldsDirective = /** @class */ (function () {
    ...
    ***************************************************************************** */
    ...
    var DATE_PICKER_VALUE_ACCESSOR = {
        ...
        useExisting: core.forwardRef(function () { return DatePickerValueAccessor; }),
        multi: true,
    };
    var TIME_PICKER_VALUE_ACCESSOR = {
        provide: forms.NG_VALUE_ACCESSOR,
        useExisting: core.forwardRef(function () { return TimePickerValueAccessor; }),
        multi: true,
    };
    var DATE_TIME_PICKERS_VALUE_ACCESSOR = {
        provide: forms.NG_VALUE_ACCESSOR,
        useExisting: core.forwardRef(function () { return DateTimePickersValueAccessor; }),
        multi: true,
    };
    /**
     ...
     *  ```
     */
    var DatePickerValueAccessor = /** @class */ (function (_super) {
    ...
    DatePickerValueAccessor.ctorParameters = function () { return [
     ...
     *  ```
     */
    var TimePickerValueAccessor = /** @class */ (function (_super) {
    ...
    TimePickerValueAccessor.ctorParameters = function () { return [
        { type: core.ElementRef }
    ]; };
    /**
     * The accessor for setting a date and listening to changes that is used by the
     ...
     *  ```
     */
    var DateTimePickersValueAccessor = /** @class */ (function (_super) {
    ...
    DateTimePickersValueAccessor.ctorParameters = function () { return [
        { type: core.ElementRef }
    ]; };

    var NativeScriptDateTimePickerModule = /** @class */ (function () {
    ...
    angular.registerElement("DatePickerField", function () { return datetimepicker.DatePickerField; });
    angular.registerElement("TimePickerField", function () { return datetimepicker.TimePickerField; });
    angular.registerElement("DateTimePickerFields", function () { return datetimepicker.DateTimePickerFields; });
...
//# sourceMappingURL=nativescript-datetimepicker-angular.umd.js.map
